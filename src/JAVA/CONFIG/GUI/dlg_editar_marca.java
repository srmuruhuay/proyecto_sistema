...
public class dlg_editar_marca extends javax.swing.JDialog {
    ...
    public dlg_editar_marca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        formulario();
    }
    ...
    private void formulario() {
        lo_pnl_datos_marca.setBounds(10, 10, 450, 350);
        this.add(lo_pnl_datos_marca);

        ls_codigo = gs_parametros[0];
        lo_pnl_datos_marca.TXT_codigo.setText(gs_parametros[0]);
        lo_pnl_datos_marca.TXT_nombre.setText(gs_parametros[1]);
        lo_pnl_datos_marca.CBX_estado.setSelectedIndex(Integer.parseInt(gs_parametros[2]));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlg_editar_marca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlg_editar_marca dialog = new dlg_editar_marca(new javax.swing.JFrame(), true);
