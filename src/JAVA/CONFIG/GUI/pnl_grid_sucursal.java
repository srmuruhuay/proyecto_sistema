...
public class pnl_grid_sucursal extends javax.swing.JPanel {

    public pnl_grid_sucursal() {
        initComponents();
        TXT_dato.addFocusListener(new evt_focus_general());
        TXT_dato.setDocument(new fnc_txt_mayuscula());
        
        go_fnc_opera_campos.ancho_columna(TBL_sucursal, 0, 50);
        go_fnc_opera_campos.ancho_columna(TBL_sucursal, 1, 160);
        go_fnc_opera_campos.ancho_columna(TBL_sucursal, 2, 160);
        go_fnc_opera_campos.ancho_columna(TBL_sucursal, 3, 0);
        go_fnc_opera_campos.ancho_columna(TBL_sucursal, 4, 0);
        go_fnc_opera_campos.ancho_columna(TBL_sucursal, 5, 0);
        go_fnc_opera_campos.ancho_columna(TBL_sucursal, 6, 0);
        go_fnc_opera_campos.ancho_columna(TBL_sucursal, 7, 90);
    }
    ...
    private void initComponents() {
        ...
        TBL_sucursal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Nombre", "Direccion", "nota", "status", "codigi_ubigeo", "descripcion", "Estado"
            }
        ) {
        ...
        if (TBL_sucursal.getColumnModel().getColumnCount() > 0) {
            ...
            TBL_sucursal.getColumnModel().getColumn(3).setResizable(false);
            TBL_sucursal.getColumnModel().getColumn(4).setResizable(false);
            TBL_sucursal.getColumnModel().getColumn(5).setResizable(false);
            TBL_sucursal.getColumnModel().getColumn(6).setResizable(false);
            TBL_sucursal.getColumnModel().getColumn(7).setResizable(false);
        }
