...
public class pnl_grid_grupo extends javax.swing.JPanel {

    public pnl_grid_grupo() {
        initComponents();
        TXT_dato.addFocusListener(new evt_focus_general());
        TXT_dato.setDocument(new fnc_txt_mayuscula());

        go_fnc_opera_campos.ancho_columna(TBL_grupo, 0, 100);
        go_fnc_opera_campos.ancho_columna(TBL_grupo, 1, 350);
    }
    ...
    private void initComponents() {
        ...
        TBL_grupo.setFont(new java.awt.Font("Arial", 0, 10)); // NOI18N
        ...
        if (TBL_grupo.getColumnModel().getColumnCount() > 0) {
    ...
    public javax.swing.JTable TBL_grupo;
