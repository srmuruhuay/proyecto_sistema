...
public class pnl_grid_marca extends javax.swing.JPanel {

    public pnl_grid_marca() {
        initComponents();
        TXT_dato.addFocusListener(new evt_focus_general());
        TXT_dato.setDocument(new fnc_txt_mayuscula());

        go_fnc_opera_campos.ancho_columna(TBL_marca, 0, 80);
        go_fnc_opera_campos.ancho_columna(TBL_marca, 1, 250);
        go_fnc_opera_campos.ancho_columna(TBL_marca, 2, 0);
        go_fnc_opera_campos.ancho_columna(TBL_marca, 3, 110);
    }
    ...
    private void initComponents() {
        ...
        if (TBL_marca.getColumnModel().getColumnCount() > 0) {
            ...
            TBL_marca.getColumnModel().getColumn(3).setResizable(false);
        }
