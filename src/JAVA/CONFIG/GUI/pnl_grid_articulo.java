...
public class pnl_grid_articulo extends javax.swing.JPanel {

    public pnl_grid_articulo() {
        initComponents();
        ...
        go_fnc_opera_campos.ancho_columna(TBL_marca, 1, 280);
        go_fnc_opera_campos.ancho_columna(TBL_marca, 2, 100);
    }
