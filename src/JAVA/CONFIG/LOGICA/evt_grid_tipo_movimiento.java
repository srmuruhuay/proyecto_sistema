...
import JAVA.CONFIG.GUI.pnl_grid_tipo_movimiento;
import java.awt.event.KeyListener;
import java.sql.ResultSet;
import javax.swing.table.DefaultTableModel;

public class evt_grid_tipo_movimiento {
    ...
    public void datos_tabla(DefaultTableModel modelo) {
        ...
        int a = 0;
        try {
            lq_rs = go_dao_tipo_movimiento.SLT_datos_tipo_movimiento("%");
            if (lq_rs != null) {
                do {
                    ...
                    modelo.setValueAt(lq_rs.getString(12), a, 10);
                    a++;
                } while (lq_rs.next());
            }
        } catch (Exception e) {
    ...
    public KeyListener evento_press(pnl_grid_tipo_movimiento OBJ_pnl, KeyListener KeyEvnt) {
        OBJ_pnl.TXT_dato.addKeyListener(KeyEvnt);     
        OBJ_pnl.TBL_tipo_movimiento.addKeyListener(KeyEvnt);
        return KeyEvnt;
    }
}
