...
import JAVA.CONFIG.GUI.pnl_grid_sucursal;
import java.awt.event.KeyListener;
import java.sql.ResultSet;
import javax.swing.table.DefaultTableModel;

public class evt_grid_sucursal {
    ...
    public void datos_tabla(DefaultTableModel modelo) {
        ...
        int a = 0;
        try {
            lq_rs = go_dao_sucursal.SLT_datos_sucursal("%");
            if (lq_rs != null) {
                do {
    ...
    public KeyListener evento_press(pnl_grid_sucursal OBJ_pnl, KeyListener KeyEvnt) {
        OBJ_pnl.TXT_dato.addKeyListener(KeyEvnt);     
        OBJ_pnl.TBL_sucursal.addKeyListener(KeyEvnt);
        return KeyEvnt;
    }
}
