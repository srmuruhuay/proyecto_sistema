...
import JAVA.CONFIG.GUI.pnl_grid_familia;
import java.awt.event.KeyListener;
import java.sql.ResultSet;
import javax.swing.table.DefaultTableModel;

public class evt_grid_familia {
    ...
    public void datos_tabla(DefaultTableModel modelo) {
        ...
        int a = 0;
        try {
            lq_rs = go_dao_familia.SLT_datos_familia("%");
            if (lq_rs != null) {
                do {
    ...
    public KeyListener evento_press(pnl_grid_familia OBJ_pnl, KeyListener KeyEvnt) {
